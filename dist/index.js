...
async function run() {
    try {
        ...
        report_1.report(filename, repository, token_id, token_secret);
    }
    catch (error) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.report = exports.BlinkaClient = exports.BlinkaError = void 0;
const fs_1 = __importDefault(__nccwpck_require__(747));
const mime_1 = __importDefault(__nccwpck_require__(994));
...
async function report(filename, repository, token_id, token_secret, blinka_host = 'https://www.blinka.app/api/v1') {
